        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm sm:p-8">
          ...
          <form onSubmit={submit} className="space-y-4">
              ...
              <div className="flex items-center">
                <label className="flex items-center gap-2 cursor-pointer select-none">
                  <input
                    ...
                    className="rounded border-input text-secondary focus:ring-secondary h-4 w-4 accent-secondary"
                  />
            ...
            <button
              type="submit"
              disabled={loading}
              className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-secondary px-4 py-3 font-semibold text-secondary-foreground hover:bg-primary disabled:opacity-60 cursor-pointer"
            >
